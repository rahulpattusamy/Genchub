  ...
  return (
    <header className="w-full top-0 z-50 sticky justify-between px-4 py-4 bg-red-400 p-5 text-white dark:bg-neutral-900 ">
      ...
      <div className=" flex gap-4  lg:flex shrink-0 md:gap-8">
        ...
        <span className="w-6 h-6 ml-5  lg:text-sm bg-gray-700 lg:w-8 lg:h-8 rounded-3xl flex justify-center items-center text-center lg:ml-5 -mt-2  absolute dark:bg-white dark:text-black">
        ...
        <span className="w-6 h-6 m-15  md:ml-20 lg:text-sm bg-gray-700 lg:w-8 lg:h-8 rounded-3xl flex justify-center items-center text-center lg:ml-22 -mt-2  absolute dark:bg-white dark:text-black">
